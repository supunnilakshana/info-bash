      ...
      body: SizedBox(
        ...
        child: StreamBuilder<dynamic>(
            stream: FirebaseFirestore.instance
                .collection(CollectionPath.matchsround1)
                .where("matchstatus", isEqualTo: Matchstatustype.ongoning)
                .snapshots(),
            builder: (context, snapshot) {
              if (snapshot.hasData) {
                ...
                var matchModel =
                    MatchModel.fromMap(d.id, d.data() as Map<String, dynamic>);
                matchModel.toMap();
                String ballpath = CollectionPath.ballpath(matchModel.id!);
                ...
                if (matchModel.matchstatus == Matchstatustype.notstared) {
                  return Center(
                    ...
                    children: [
                      ...
                      const Text("Match is not started yet")
                    ],
                  ));
                } else {
                  return Column(
